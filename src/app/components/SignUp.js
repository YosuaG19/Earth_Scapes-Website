...
export default function SignupCard() {
  ...
  useEffect(() => {
    ...
    // Cleanup: kembalikan scroll saat komponen unmount
    return () => {
  ...
  const handleSocialSignup = (provider) => {
    ...
    // Implementasi OAuth nyata akan redirect ke provider
  ...
  return (
    <div 
      ...
      style={{
        ...
        backgroundAttachment: 'fixed', // Ini biar background tetap saat scroll
      }}
    >
      ...
      {/* Card Container */}
      <div className="bg-white rounded-[1rem] shadow-2xl/30 overflow-hidden flex flex-col md:flex-row w-full max-w-4xl mx-4 h-[95vh] max-h-[700px] relative z-10">
        {/* Left Side - Dengan Background Image */}
        <div 
          className="h-full w-full md:w-1/2 p-4 md:p-6 flex flex-col justify-center relative overflow-hidden"
          style={{
        ...
        >
          {/* Overlay gelap untuk meningkatkan readability teks */}
          ...
          <div className="relative z-10 text-center">
            ...
            <div className="text-white/90 text-xs md:text-sm mb-4">
              Join our community of nature enthusiasts
            </div>
            
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-center md:justify-start">
                <div className="w-6 h-6 rounded-full bg-white/30 backdrop-blur-sm flex items-center justify-center mr-2">
        ...
        {/* Right Side - Form */}
        <div className="h-full w-full md:w-1/2 bg-[#626F47] p-4 md:p-6 flex flex-col justify-center overflow-y-auto">
          <div className="text-center mb-3">
            <h1 className="text-xl md:text-2xl text-[#F5ECD5] mb-1">
              EarthScape
            </h1>
          ...
          <div className="mt-3 text-center text-[#F5ECD5] text-[10px]">
            <div>
              ...
              <Link className="underline underline-offset-1 hover:text-[#F5ECD5]/80" href="/signin">
                Sign In
              </Link>
            </div>
          </div>
