    ...
    return(
        <>
            <div className="relative flex flex-col text-[#e8e8da] items-start min-w-full h-[90vh] shadow-xl/30">
                <div className="z-2 absolute w-full h-full bg-black/50"></div>

                <div className="z-1 absolute flex justify-center items-center overflow-hidden w-full h-full">
                    <Image className="object-cover w-full h-full" src={banner_bg} alt="BG"></Image>
                </div>

                <div className="z-5 w-[55%] h-full flex flex-col justify-end items-center p-12 text-[1rem] gap-[.4rem]">
                    <h1 className="text-[3rem] text-left leading-14">
