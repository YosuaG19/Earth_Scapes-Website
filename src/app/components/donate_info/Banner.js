...
const Banner = (props) =>{
    ...
    return(
        <>
            <div className="relative flex items-end justify-center min-h-[85vh] h-screen w-full p-6 text-[#e8e8da]">
                ...
                <div className="relative w-full h-full flex items-center justify-center overflow-hidden rounded-tr-[3rem]">
                    <Image_Damper name={props.hero} img={props.hero}></Image_Damper>
                    <div className="z-3 absolute bottom-8 px-8 flex justify-between items-end w-full">
                        <div className="flex flex-col">
                            <h1 className="text-[3rem] -mb-6">Make Donation for</h1>
