...
import Script from "next/script"; // Tambahan untuk Midtrans
...
const Information = (props) =>{
        ...
        try {
            ...
            if (data.token) {
                window.snap.pay(data.token, {
                    onSuccess: (result) => {
                        // Progress bar update hanya kalau bayar sukses
    ...
    return(
        <>
            {/* Memanggil library Snap Midtrans */}
            <Script 
            ...
            <div className="flex flex-col w-full px-[1.5rem]">
                ...
                <div className="flex pt-[1rem] h-[50vh] gap-[1rem]">
                    <div className="w-[50%] h-full flex flex-col">
                        {/* Menggunakan data hero dari props */}
                        ...
                        <div className="w-full flex flex-col gap-[1.25rem]">
                            <div className="w-full flex flex-col gap-[.2rem]">
                                ...
                                <div style={{outlineColor: props.color}} className="outline-[3px] w-full relative h-[30px] rounded-full overflow-hidden">
                                    <span style={{width: percentage + '%', background: props.color}} className="absolute h-full left-0 transition-all duration-500 rounded-full"></span>
                                </div>
                            </div>
