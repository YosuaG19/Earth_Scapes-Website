...
function Cat_Card(props) {
    return (
        ...
        <div id="cat" className="group relative flex items-end h-full w-full bg-white rounded-r-[1rem] overflow-hidden p-[.5rem] shadow-xl/30 cursor-pointer">
            ...
            <div className="z-[3] w-[75%] bg-t absolute text-white p-[1rem] transition-transform duration-500 group-hover:-translate-y-2">
